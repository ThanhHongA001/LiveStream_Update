...
public class CusBottomSheetDialog extends AppCompatDialog {
    ...
    private CusBottomSheetBehavior<FrameLayout> mBehavior;

    boolean mCancelable = true;
    private boolean mCanceledOnTouchOutside = true;
    private boolean mCanceledOnTouchOutsideSet;
    private boolean mLockDragging = false;
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        final FrameLayout container = (FrameLayout) View.inflate(getContext(), R.layout.rm_design_bottom_sheet_dialog_custom, null);
        ...
        mBehavior = (CusBottomSheetBehavior<FrameLayout>) BottomSheetBehavior.from(bottomSheet);
        mBehavior.setLocked(mLockDragging);
    ...
    public void setLockDragging(boolean block) {
        mLockDragging = block;
        if (mBehavior != null) {
            mBehavior.setLocked(mLockDragging);
        }
