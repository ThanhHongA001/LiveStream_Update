...
public class PolygonView extends ShapeOfView {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            final TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.RmPolygonView);
            final int sides = attributes.getInteger(R.styleable.RmPolygonView_shape_polygon_noOfSides, numberOfSides);
