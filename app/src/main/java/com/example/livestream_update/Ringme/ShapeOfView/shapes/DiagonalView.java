...
public class DiagonalView extends ShapeOfView {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            final TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.RmDiagonalView);
            diagonalAngle = attributes.getInteger(R.styleable.RmDiagonalView_shape_diagonal_angle, diagonalAngle);
            diagonalDirection = attributes.getInteger(R.styleable.RmDiagonalView_shape_diagonal_direction, diagonalDirection);
            diagonalPosition = attributes.getInteger(R.styleable.RmDiagonalView_shape_diagonal_position, diagonalPosition);
            attributes.recycle();
        }
