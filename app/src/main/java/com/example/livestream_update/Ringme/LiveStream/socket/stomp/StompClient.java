...
import com.vtm.ringme.livestream.socket.stomp.dto.StompCommand;
...
import com.vtm.ringme.livestream.socket.stomp.pathmatcher.PathMatcher;
import com.vtm.ringme.livestream.socket.stomp.pathmatcher.SimplePathMatcher;
import com.vtm.ringme.livestream.socket.stomp.provider.ConnectionProvider;
...
public class StompClient {
    ...
    public boolean isConnected() {
        try {
            if (getConnectionStream() != null && getConnectionStream().getValue() != null) {
