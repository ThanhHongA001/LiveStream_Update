...
public class CircleImageView extends ImageView {
    ...
    private void applyColorFilter() {
        if (!checkObjectNull(mBitmapPaint)) {
            mBitmapPaint.setColorFilter(mColorFilter);
        }
    }

    private boolean checkObjectNull(Object obj) {
        return (obj == null);
    }
    ...
    private void setup() {
        ...
        mBorderRadius = Math.min((mBorderRect.height() - mBorderWidth) / 2.0f, (mBorderRect.width() - mBorderWidth) /
                2.0f);
