...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
                mShadowDrawable = getResources().getDrawable(R.drawable.rm_above_shadow);
            } else {
                mShadowDrawable = getResources().getDrawable(R.drawable.rm_below_shadow);
            }
        } else {
            mShadowDrawable = null;
        }
    ...
    public boolean ismIsScrollableViewHandlingTouch() {
    ...
    void dispatchOnPanelStateChanged(View panel, PanelState previousState, PanelState newState) {
        Log.d("SlidingUpPanelLayout", "dispatchOnPanelStateChanged previousState: " + previousState + ", newState: " + newState);
        synchronized (mPanelSlideListeners) {
            for (PanelSlideListener l : mPanelSlideListeners) {
...
//        @SuppressLint("WrongConstant") final int save = canvas.save(Canvas.CLIP_SAVE_FLAG);
        @SuppressLint("WrongConstant") final int save = canvas.save();
