...
public class TriangleView extends ShapeOfView {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            final TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.RmTriangleView);
            percentBottom = attributes.getFloat(R.styleable.RmTriangleView_shape_triangle_percentBottom, percentBottom);
            percentLeft = attributes.getFloat(R.styleable.RmTriangleView_shape_triangle_percentLeft, percentLeft);
            percentRight = attributes.getFloat(R.styleable.RmTriangleView_shape_triangle_percentRight, percentRight);
            attributes.recycle();
        }
