package com.example.livestream_update.Ringme.ShapeOfView;
...
import com.vtm.R;
import com.vtm.ringme.shapeofview.manager.ClipManager;
...
//        super.setBackgroundColor(color);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            final TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.RmShapeOfView);

            if (attributes.hasValue(R.styleable.RmShapeOfView_shape_clip_drawable)) {
                final int resourceId = attributes.getResourceId(R.styleable.RmShapeOfView_shape_clip_drawable, -1);
                if (-1 != resourceId) {
...
//import androidx.core.view.ViewCompat;
//import androidx.appcompat.content.res.AppCompatResources;
//import android.utils.AttributeSet;
//import android.utils.TypedValue;
//import android.view.View;
//import android.view.ViewOutlineProvider;
//import android.widget.FrameLayout;
//
//import com.ringme.shapeofview.manager.ClipManager;
//import com.ringme.shapeofview.manager.ClipPathManager;
//
//public class ShapeOfView extends FrameLayout {
//
//    private final Paint clipPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
