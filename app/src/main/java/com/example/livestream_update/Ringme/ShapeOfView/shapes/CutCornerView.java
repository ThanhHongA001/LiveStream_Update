...
public class CutCornerView extends ShapeOfView {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            final TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.RmCutCornerView);
            topLeftCutSize = attributes.getDimensionPixelSize(R.styleable.RmCutCornerView_shape_cutCorner_topLeftSize, topLeftCutSize);
            topRightCutSize = attributes.getDimensionPixelSize(R.styleable.RmCutCornerView_shape_cutCorner_topRightSize, topRightCutSize);
            bottomLeftCutSize = attributes.getDimensionPixelSize(R.styleable.RmCutCornerView_shape_cutCorner_bottomLeftSize, bottomLeftCutSize);
            bottomRightCutSize = attributes.getDimensionPixelSize(R.styleable.RmCutCornerView_shape_cutCorner_bottomRightSize, bottomRightCutSize);
            attributes.recycle();
        }
