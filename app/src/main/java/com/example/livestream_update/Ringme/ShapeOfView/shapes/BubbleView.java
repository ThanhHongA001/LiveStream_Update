...
public class BubbleView extends ShapeOfView {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            final TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.RmBubbleView);
            borderRadiusPx = attributes.getDimensionPixelSize(R.styleable.RmBubbleView_shape_bubble_borderRadius, dpToPx(10));
            position = attributes.getInteger(R.styleable.RmBubbleView_shape_bubble_arrowPosition, position);
            arrowHeightPx = attributes.getDimensionPixelSize(R.styleable.RmBubbleView_shape_bubble_arrowHeight, dpToPx(10));
            arrowWidthPx = attributes.getDimensionPixelSize(R.styleable.RmBubbleView_shape_bubble_arrowWidth, dpToPx(10));
            attributes.recycle();
        }
