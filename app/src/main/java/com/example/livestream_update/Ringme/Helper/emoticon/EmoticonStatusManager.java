...
public class EmoticonStatusManager {
    private static final String TAG = EmoticonStatusManager.class.getSimpleName();
    private static final int EMO_CACHE_SIZE = 4 * 1024 * 1024;
    private static EmoticonStatusManager instance = null;
    ...
    private EmoticonStatusManager(Context ctx) {
